...
When executed, this python script can be used for mapping all endpoints in the LAN, including an OS detection of the endpoints (similar to the Nmap tool). The script is adapted to windows OS only.
